...
public class PdfReportGeneratorService {
    ...
    private String getOwnerName(Long ownerId) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error getting owner name: " + ownerId, e);
        }
    }

    private float drawTextLine(PDPageContentStream contentStream, float x, float y, String text, PDFont font, float fontSize) throws IOException {
